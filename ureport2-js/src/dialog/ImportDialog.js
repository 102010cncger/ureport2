...
export default class ImportDialog{
    ...
    initBody(body,footer){
        ...
        body.append(form);
        form.append(`<div style="margin-bottom: 10px;line-height: 2;color: #929191;">此操作将导入Excel的第一个Sheet页内容，如果选择是的xlsx格式的Excel文件，导入后发现背景色未正常解析，可将该文件另存为xls格式，再次上传这个xls格式Excle文件即可。</div>`);
